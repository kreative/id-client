...
export default function TermsAndConditions(): JSX.Element {
  return (
    <>
      <Head>
        <title>Terms and Conditions | Kreative ID</title>
        <meta
          name="description"
      ...
      <main>
        <div className="mx-auto max-w-7xl px-6 pb-24 lg:px-8" aria-label="Top">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-24 lg:px-8">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Kreative Support, accessible
                from{" "}
                <Link
          ...
          <ul>
            <li>
              <p>By email: support@kreativeusa.com</p>
            </li>
            <li>
              <p>
                ...
                <Link
                  ...
                  target="_blank"
                >
                  https://support.kreativeusa.com/submit-issue
                </Link>
              </p>
            </li>
          </ul>
