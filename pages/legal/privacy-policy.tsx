...
export default function PrivacyPolicy(): JSX.Element {
  return (
    <>
      <Head>
        <title>Privacy Policy | Kreative ID</title>
        <meta
          name="description"
      ...
      <main>
        <div className="mx-auto max-w-7xl px-6 pb-24 lg:px-8" aria-label="Top">
          <h1 className="pb-6 pt-6 text-2xl font-bold">Privacy Policy</h1>
          ...
          <h1 className="pb-6 pt-6 text-2xl font-bold">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Kreative Hyperlink,
                accessible from{" "}
                <a
          ...
          <h1 className="pb-6 pt-6 text-2xl font-bold">Contact Us</h1>
          <p>
          ...
          <ul>
            <li>
              <p>By email: privacy@kreativeusa.com</p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>By phone number: 5106735179</p>
            </li>
          </ul>
        </div>
      </main>
